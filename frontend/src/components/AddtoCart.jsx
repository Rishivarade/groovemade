...
const AddtoCart = () => {
  ...
  const cartData = () => {
    axios.get(`https://cosmo-backend.onrender.com/cart`)
      .then((res) => setCart(res.data))
      .catch((err) => console.log(err));
  };

  const deleteProduct = (id) => {
    axios.delete(`https://cosmo-backend.onrender.com/cart/${id}`)
      .then((res) => {
  ...
  const updateQuantity = (id, quantity) => {
    axios.patch(`https://cosmo-backend.onrender.com/cart/${id}`, { quantity })
      .then((res) => {
        console.log(res.data);
        cartData();
      })
  ...
  return (
    <>
      <div id='oncart' className='cart col-12 pt-1'>
        ...
        <div className="container-fluid col-11 mt-5" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <a className='col-1 text-center pt-2 pb-2 d-sm-none d-md-block' href='#oncart' style={{ textDecoration: "none", backgroundColor: theme == "light" ? "black" : "white", color: theme == "light" ? "white" : "black", alignContent: "center", fontFamily: "din-2014,helvetica,ssans-serif" }}>GO <br /> UP</a>
        </div>
