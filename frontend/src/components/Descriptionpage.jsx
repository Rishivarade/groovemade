...
let url = 'https://cosmo-backend.onrender.com/products'
const Descriptionpage = () => {
  ...
  const Descriptiondata = () => {
    axios.get(`https://cosmo-backend.onrender.com/products/${params.id}`)
      .then((res) => {
  ...
  return (
    <>
      <div id='ondesc' className='container pt-2' style={{ textAlign: "center", marginTop: "10px", }}>
        <div className="desc col-10 d-flex flex-sm-column flex-lg-row justify-content-between align-items-center">
          <ReactImageMagnify {...{
            smallImage: {
              alt: '',
              isFluidWidth: true,
              src: descriptionpro.image
            },
            largeImage: {
              src: descriptionpro.image,
              width: 700,
          ...
          <div className="div col-3 col-sm-6 col-lg-3">
            ...
            <button className='col-12 p-2 mt-4' style={{ border: "0px", backgroundColor: theme == "light" ? "black" : "white", color: theme == "light" ? "white" : "black", fontFamily: "din-2014,helvetica,sans-serif", fontSize: "14px" }} onClick={
              () => {
                axios.post('https://cosmo-backend.onrender.com/cart', {
      ...
      <div className="container-fluid col-11 mt-5" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <a className='col-1 text-center pt-2 pb-2 d-sm-none d-md-block' href='#ondesc' style={{ textDecoration: "none", backgroundColor: theme == "light" ? "black" : "white", color: theme == "light" ? "white" : "black", alignContent: "center", fontFamily: "din-2014,helvetica,ssans-serif" }}>GO <br /> UP</a>
      </div>
