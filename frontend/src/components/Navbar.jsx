...
import { IoLogoInstagram, IoPartlySunny } from 'react-icons/io5';
import { FaFacebookF, FaLinkedin, FaMoon } from 'react-icons/fa';
...
import { BsFillGrid3X2GapFill, BsFillHddStackFill, BsHddStack } from 'react-icons/bs';
...
const Navbar = () => {
    ...
    return (
        <>
            ...
            <div id='top' className='fixed-top  ' style={{ display: "flex", justifyContent: "space-between", backgroundColor: theme == "light" ? "white" : "black", color: theme == "light" ? "black" : "white", padding: "25px", fontWeight: "bold", fontSize: "14px", border: theme == "light" ? "" : "1px solid white" }}>

                <div className="div d-sm-block d-lg-none">
                    <Button style={{backgroundColor: theme == "light" ? "black" : "white", color: theme == "light" ? "white" : "black"}} onClick={handleShow}>
                        <BsHddStack />

                    </Button>

                    <Offcanvas style={{backgroundColor: theme == "light" ? "white" : "black", color: theme == "light" ? "black" : "white"}} 
                    show={show} onHide={handleClose}>
                        <Offcanvas.Header closeButton>                        
                            <Offcanvas.Title>NAVBAR <br/><br />
                            <a style={{
                        border: "2px solid black", borderRadius: "25px", padding: "5px 10px 10px 10px",
                        backgroundColor: theme == "light" ? "black" : "skyblue",
                        color: theme == "light" ? "white" : "black"
                    }}
                        onClick={() => themeUpdaterfunction("dark")}>
                        {theme == "light" ? <FaMoon /> : <IoPartlySunny style={{ color: "yellow" }} />}
                    </a>
                            </Offcanvas.Title>
                            
                        </Offcanvas.Header>
                        <Offcanvas.Body>
                            <Link style={{ color: theme == "light" ? "black" : "white", textDecoration: "none", fontFamily: "din-2014,helvetica,sans-serif" }} to={'/product'}>SHOP</Link> <br />
                            <hr />
                            <Link style={{ color: theme == "light" ? "black" : "white", textDecoration: "none", fontFamily: "din-2014,helvetica,sans-serif" }} to={'/explore'}>EXPLORE</Link><br />
                            <hr />
                            <Link style={{ color: theme == "light" ? "black" : "white", textDecoration: "none", fontFamily: "din-2014,helvetica,sans-serif" }} to={'/cart'}>CART</Link><br />
                            <hr />
                            <Link style={{ color: theme == "light" ? "black" : "white", border: "0px", textDecoration: "none" }} to={'/login'}>LOGIN</Link><br />
                            <hr />
                            <div className=" col-4">
                                <ul style={{ listStyle: "none", display: "flex", justifyContent: "space-between", alignItems: "center", fontSize: "20px", padding: "0px" }}>
                                    <li><a href="" style={{color: theme == "light" ? "black" : "white" }}><FaFacebookF /></a></li>
                                    <li><a href="" style={{color: theme == "light" ? "black" : "white"}}><IoLogoInstagram /></a></li>
                                    <li><a href="" style={{color: theme == "light" ? "black" : "white" }}><FaLinkedin /></a></li>
                                </ul>
                            </div>
                            <hr />
                            <div className="col-6 m-auto">
                                <svg className="svg-logo" version="1.1" alt="Grovemade Logo - at top of page - click to return to homepage" baseProfile="tiny" id="Layer_1" x="0px" y="0px" viewBox="0 0 136.9 11.5">
                                    <g>
			...
			C7.9,6.6,7.8,6.9,7.9,7.2C8,7.5,8.6,8.7,9,9.7c0.6,1.4,0.7,1.8,2,1.8C12.6,11.5,13.7,10.1,13.7,7.7z"></path>
                ...
                <div className="col-2 d-flex justify-content-start d-sm-none d-lg-flex flex-sm-column flex-md-row">
                ...
                <div className="col-2 text-end col-sm-1 d-sm-none d-lg-block"  >
                    <a style={{
                        border: "2px solid black", borderRadius: "25px", padding: "5px 10px 10px 10px",
                        backgroundColor: theme == "light" ? "black" : "skyblue",
                        color: theme == "light" ? "white" : "black"
                ...
                <div className=" div col-2 ms-sm-5 col-sm-4 col-lg-2 text-center">
                    <Link className='' style={{ color: theme == "light" ? "black" : "white" }} to={'/'}>
                        <svg className="svg-logo" version="1.1" alt="Grovemade Logo - at top of page - click to return to homepage" baseProfile="tiny" id="Layer_1" x="0px" y="0px" viewBox="0 0 136.9 11.5">
                            <g>
                                <path fill="#272524" d="M23.9,2c0.3-0.3,0.7-0.5,1.1-0.5h0.2c0.4,0,0.8,0.1,1.1,0.3c0.3,0.2,0.5,0.5,0.5,0.8c0,0.3,0.1,0.4,0.3,0.5
			c0.2,0.1,0.3,0.2,0.5,0.2c0.2,0,0.4-0.1,0.5-0.2c0.2-0.1,0.2-0.3,0.2-0.6V2.6c0-0.4-0.1-0.7-0.3-1c-0.2-0.3-0.4-0.6-0.7-0.8
			...
			C7.9,6.6,7.8,6.9,7.9,7.2C8,7.5,8.6,8.7,9,9.7c0.6,1.4,0.7,1.8,2,1.8C12.6,11.5,13.7,10.1,13.7,7.7z"></path>
                ...
                <div className="col-2  d-flex justify-content-around d-sm-none d-md-none d-lg-flex">
                    <Link to={'/login'}>
                    ...
                    <button className='' style={{ backgroundColor: theme == "light" ? "black" : "white", color: theme == "light" ? "white" : "black", border: "0px" }} onClick={handlelogout}>LOG OUT</button>
                </div>
                <div className=" div col-2 col-sm-4 col-md-3 col-lg-2 text-center ">
