...
const Home = () => {
  ...
  return (
    <>
      {/*Banner-1*/}
      <div id='above' className='home pt-5 mt-5' style={{ color: "white", textAlign: "right", display: "flex", flexDirection: "row" }}>
      ...
      <div className="div mt-5 d-sm-none d-md-none d-lg-block" style={{ textAlign: "center" }}>
        ...
        <button style={{ border: "none", backgroundColor: "white", borderBottom: "1px solid black", fontWeight: "bold", fontFamily: "din-2014,helvetica,sans-serif",marginBottom:"10px"}}>GET STARTED</button>
      </div>
      {/*Bannerimage-1*/}
      <div className="div col-12 d-none d-sm-none d-md-none d-lg-flex" style={{ display: "flex", justifyContent: "space-around" }}>
      ...
      <div className="container-fluid col-11 mt-5 d-flex justify-content-between align-items-center" >
        ...
        <a className='col-1 text-center pt-2 pb-2 d-sm-none d-md-block' href='#above' style={{ textDecoration: "none", backgroundColor: theme == "light" ? "black" : "white",color: theme == "light" ? "white" : "black", alignContent: "center", fontFamily: "din-2014,helvetica,ssans-serif" }}>GO <br /> UP</a>
      </div>
      <div className="div mt-5 d-none d-flex justify-content-between d-sm-none d-md-none d-lg-flex">
        <div className="col-1">
