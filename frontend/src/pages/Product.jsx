...
const Product = () => {
  ...
  return (
    <>
      ...
      <div className="div col-12 order d-lg-none d-flex justify-content-evenly">
        <h4>SORT PRICE :</h4>
          <button style={{backgroundColor: theme == "light" ? "black" : "white", color: theme == "light" ? "white" : "black"}} onClick={()=>setorder("asc")}>LOW-TO-HIGH</button>
          <button  style={{backgroundColor: theme == "light" ? "black" : "white", color: theme == "light" ? "white" : "black"}} onClick={()=>setorder("desc")}>HIGH-TO-LOW</button>
        </div>
        <hr className='d-lg-none' />
      ...
      <div className="div col-11 m-auto mt-5 d-flex justify-content-between align-items-center d-sm-none d-md-none d-lg-flex">
        ...
        <div className="col-2 text-center">
          <img src="https://grovemade.imgix.net/https%3A%2F%2Fsiteleaf.grovemade.com%2Fuploads%2Ffeature-note-taking-kit-A1.jpg?auto=format&ixlib=python-1.1.2&w=300&s=30ce17d2076884b7ca3b8697537a48b6" width={250} alt="" />
